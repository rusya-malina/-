...
KPI_REFERENCE_FILE = str(BASE_DIR / "kpi_reference.json")
...
LATEST_KPI_REFERENCE_FILE = os.path.join(UPLOADED_DATA_DIR, "latest_monthly_kpi.xlsx")
...
GROUPS_WITH_OFFHOURS_VISITS = frozenset({"A LAMP", "R LAMP"})
